...
export default function ConnexionPage() {
  ...
  return (
    <div className="min-h-screen bg-landing-background font-landing-body-md text-landing-on-background flex flex-col items-center justify-center p-4">
      ...
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-tr from-landing-primary-container/10 to-transparent pointer-events-none z-0"></div>
      ...
      <div className="w-full max-w-md z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="glass-card rounded-2xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-landing-outline-variant/50 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <h1 className="font-landing-headline-md text-2xl font-bold text-landing-on-surface mb-2">Bon retour !</h1>
            <p className="font-landing-body-sm text-landing-on-surface-variant">Connectez-vous pour accéder à votre tableau de bord.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); window.location.href = '/tableau-de-bord'; }}>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="font-landing-body-sm text-xs text-landing-primary hover:underline">Mot de passe oublié ?</a>
              </div>
              <input 
                type="password" 
                placeholder="••••••••"
          ...
          <div className="mt-8 text-center">
            <span className="font-landing-body-sm text-landing-on-surface-variant">
              ...
              <Link href="/inscription" className="text-landing-primary font-landing-label-md hover:underline">
                S'inscrire
              </Link>
            </span>
          </div>
